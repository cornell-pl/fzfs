...
(*K: I see why the downs are needed, but this feels like it goes
 * against intuition, because your just going right/left through a
 * directory, why cant dir be lists like comprehensions*)
